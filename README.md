...
1. [`01_top_demanded_skills.sql`](lessons\01_top_demanded_skills.sql) – demand analysis with multi-table joins  
2. [`02_top_paying_skills.sql`](lessons\02_top_paying_skills.sql) – salary analysis with aggregations  
3. [`03_optimal_skills.sql`](lessons\03_optimal_skills.sql) – combined demand/salary optimization query  
